...
import MerchantTypeFormView from 'views/manager/merchantType/form';
class MerchantTypeView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    onDelete=async(e)=>{
        ...
        const response = await post("/api/merchant/type/delete",params).catch(error => {
    ...
    render(){
        ...
        return (
        <Fragment>
            <MerchantTypeFormView ref={this.formRef} reloadTable={this.onReload}></MerchantTypeFormView>
            <div className='ds-back-layout'>
                <Breadcrumb className='ds-crumb'>
                    <Breadcrumb.Item>首页</Breadcrumb.Item>
                    <Breadcrumb.Item>商户类型管理</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/merchant/type/find'} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
...
export default MerchantTypeView;