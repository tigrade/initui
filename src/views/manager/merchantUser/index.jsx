...
import CustomerFormView from 'views/manager/customer/form';
class MerchantUserView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    render(){
        ...
        return (
        <Fragment>
            <CustomerFormView ref={this.formRef} reloadTable={this.onReload}></CustomerFormView>
            <div className='ds-back-layout'>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/customer/find'} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
