...
import CodeSourceFormView from 'views/manager/code/source/form';
class CustomerView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    onDelete=async(e)=>{
        ...
        const response = await post("/api/code/source/delete",params).catch(error => {
    ...
    render(){
        ...
        {title: '編碼【包】',dataIndex: 'code'},
        {title: '索引編號',dataIndex: 'sourceId'},
        {title: '索引名稱',dataIndex: 'sourceName'},
        {title: '索引編碼',dataIndex: 'sourceCode'},
        ...
        return (
        <Fragment>
            <CodeSourceFormView ref={this.formRef} reloadTable={this.onReload}></CodeSourceFormView>
            <div className='ds-back-layout'>
                <Breadcrumb className='ds-crumb'>
                    <Breadcrumb.Item>首页</Breadcrumb.Item>
                    <Breadcrumb.Item>编码来源管理</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/code/source/find'} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
