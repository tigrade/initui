...
import CodeTypeFormView from 'views/manager/code/type/form';
class CodeTypeView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    onDelete=async(e)=>{
        ...
        const response = await post("/api/CodeType/delete",params).catch(error => {
    ...
    render(){
        ...
        return (
        <Fragment>
            <CodeTypeFormView ref={this.formRef} reloadTable={this.onReload}></CodeTypeFormView>
            <div className='ds-back-layout'>
                <Breadcrumb className='ds-crumb'>
                    <Breadcrumb.Item>首页</Breadcrumb.Item>
                    <Breadcrumb.Item>编码类型管理</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/code/type/find'} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
