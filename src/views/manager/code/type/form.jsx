...
class CodeTypeFormView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    static defaultProps = {
        formData:{id:"",name:"",code:""},
        formType:{add:{name:"新增编码类型",code:"1"},update:{name:"修改编码类型",code:"2"}},
        reloadTable:()=>{}
    }
    onEditor=(item)=>{
...
export default CodeTypeFormView;