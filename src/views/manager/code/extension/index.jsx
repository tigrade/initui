...
import CodeExtensionFormView from 'views/manager/code/extension/form';
class CodeExtensionView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    render(){
        ...
        {title: '编码类型',dataIndex: 'codeTypeName'},
        {title: '编码来源',dataIndex: 'codeSourceName'},
        {title: '操作',width:160,render:(value,item,index)=>{
            return (
            <Space>
                <Button type="link" onClick={this.onEditor.bind(this,item,1)}>编辑</Button>
                <Button type="link" onClick={this.onEditor.bind(this,item,2)}>属性</Button>
                <Button type="link" onClick={this.onEditor.bind(this,item,3)}>快照</Button>
        ...
        return (
        <Fragment>
            <CodeExtensionFormView ref={this.formRef} reloadTable={this.onReload}></CodeExtensionFormView>
            <div className='ds-back-layout'>
                <Breadcrumb className='ds-crumb'>
                    <Breadcrumb.Item>首页</Breadcrumb.Item>
                    <Breadcrumb.Item>编码扩展管理</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/code/extension/find'} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
...
export default CodeExtensionView;