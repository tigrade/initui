...
import CodeAttributeFormView from 'views/manager/code/attribute/form';

class CodeAttributeView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    onDelete=async(e)=>{
        ...
        const response = await post("/api/code/attribute/delete",params).catch(error => {
    ...
    render(){
        ...
        return (
        <Fragment>
            <CodeAttributeFormView ref={this.formRef} codeExtensionId={id} reloadTable={this.onReload}></CodeAttributeFormView>
            <div className='ds-back-layout'>
                <Breadcrumb className='ds-crumb'>
                    ...
                    <Breadcrumb.Item>【{this.props.location.state.name}】编码属性管理</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/code/attribute/list'} pageable={false} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
...
export default CodeAttributeView;