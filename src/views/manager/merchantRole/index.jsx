...
import MerchantRoleFormView from 'views/manager/merchantRole/form';
class MerchantRoleView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    onDelete=async(e)=>{
        ...
        const response = await post("/api/merchant/role/delete",params).catch(error => {
    ...
    render(){
        ...
        return (
        <Fragment>
            <MerchantRoleFormView ref={this.formRef} reloadTable={this.onReload}></MerchantRoleFormView>
            <div className='ds-back-layout'>
                <Breadcrumb className='ds-crumb'>
                    <Breadcrumb.Item>首页</Breadcrumb.Item>
                    <Breadcrumb.Item>商户角色管理</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/merchant/role/find'} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
...
export default MerchantRoleView;