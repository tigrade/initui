...
class CustomerFormView extends DSComponent{   
    constructor(props){
        super(props);
        ...
        <Fragment>
            <Modal
                ...
                <Form id="_form" layout="vertical" ref={this.formRef} initialValues={formData} onFinish={this.onSaveOrUpdate}>
                    ...
                    <Form.Item name="alias" label="别名" rules={[{ required: true, message: '别名不能为空' }]}>
                        <Input placeholder=""  autoComplete="off"/>
                    </Form.Item>
                </Form>
            </Modal>
