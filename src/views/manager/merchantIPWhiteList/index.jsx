...
import IPWhiteListFormView from 'views/manager/merchantIPWhiteList/form';
class IPWhiteListViewView extends DSComponent{   
    constructor(props){
        super(props);
    ...
    render(){
        ...
        {title: '类型',dataIndex: 'useType',render:(value,item,index)=>{
            if(value==="1")return "商戶登陸ip";
            if(value==="2")return "API接口ip";
            return value;
        }},
        ...
        return (
        <Fragment>
            <IPWhiteListFormView ref={this.formRef} reloadTable={this.onReload}></IPWhiteListFormView>
            <div className='ds-back-layout'>
                <Breadcrumb className='ds-crumb'>
                    <Breadcrumb.Item>首页</Breadcrumb.Item>
                    <Breadcrumb.Item>商户访问管理</Breadcrumb.Item>
                </Breadcrumb>
                ...
                <div className='ds-table'>
                    ...
                    <div className='ds-table-wrap'>
                        <DSTable columns={columns} searchCondition={searchCondition} path={'/api/merchant/ipWhiteList/find'} ref={this.tableRef}></DSTable>
                    </div>
                </div>
            </div>
        </Fragment>
...
export default IPWhiteListViewView;