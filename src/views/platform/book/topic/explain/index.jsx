...
class TopicExplainView extends DSComponent {
    constructor(props){
        super(props);
    }
    static defaultProps = {
        ...
        return (
            ...
            <div className='fl-case-detail-base' id='BASE_INFO'>
                ...
                <Collapse defaultActiveKey={['1']}>
                    <Collapse.Panel header="论述-01" key="1">
                    <div><Empty description={"暂无数据"}/>
                    </div>
                    </Collapse.Panel>
                    <Collapse.Panel header="论述-02" key="2" >
                    <div></div>
                    </Collapse.Panel>
                    <Collapse.Panel header="论述-03" key="3">
                    <div></div>
                    </Collapse.Panel>
                </Collapse>
                </div>
...
export default TopicExplainView;